void ToonShader_float(in float3 Normal, in float ToonRampSmoothness, in float3 ClipSpacePos, in float3 WorldPos, in float ToonRampTinting, in float4 RimTinting, in float ToonRampOffset, out float3 ToonRampOutput, out float3 Direction)
{
